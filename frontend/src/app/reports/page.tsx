...
type Tab = "payables" | "ip-admissions";
...
export default function ReportsPage() {
  ...
  useEffect(() => {
    setPage(1);
  }, [tab, fromDate, toDate, search, partyTypeFilter]);

  useEffect(() => {
    if (tab === "payables") fetchPayables();
    else fetchIPAdmissions();
  }, [tab, page, fromDate, toDate, search, partyTypeFilter, fetchPayables, fetchIPAdmissions]);
  ...
  return (
    <DashboardLayout>
      <div className="mb-6">
        ...
        <p className="text-slate-400 text-sm mt-1">Consolidated payables and IP admission reports</p>
      </div>
      ...
      <div className="flex flex-wrap items-center gap-3 mb-6">
        <div className="relative">
          ...
          <input
            ...
            placeholder={`Search ${tab === "payables" ? "bill no" : "IP no / patient / IP bill no"}...`}
